...
class MainWindow(QMainWindow):
    ...
    def _create_lnk_windows(lnk: str, target: str, args: str,
        ...
        try:
            ...
            sc.Description      = f"{self._assistant_name} AI Assistant"
        ...
        vbs = "\n".join([
            ...
            f'sc.Description = "{self._assistant_name} AI Assistant"',
    ...
    def _create_desktop_shortcut(self):
        ...
        ico_path = Path(__file__).resolve().parent / "config" / "Athena.ico"
    ...
    def _check_autostart(self) -> bool:
        ...
        try:
            if _OS == "Windows":
                ...
                try:
                    winreg.QueryValueEx(key, "Athena_AI")
                    return True
                ...
                return (Path.home() / "Library" / "LaunchAgents"
                        / "com.Athena.assistant.plist").exists()
            else:
                return (Path.home() / ".config" / "autostart" / "Athena.desktop").exists()
        except Exception:
            return False
    ...
    def _toggle_autostart(self):
        ...
        try:
            ...
            if _OS == "Windows":
                ...
                if currently_on:
                    winreg.DeleteValue(reg, "Athena_AI")
                else:
                    pythonw = Path(sys.executable).parent / "pythonw.exe"
                    exe = str(pythonw if pythonw.exists() else sys.executable)
                    winreg.SetValueEx(reg, "Athena_AI", 0, winreg.REG_SZ,
                                      f'"{exe}" "{script}"')
                winreg.CloseKey(reg)
            elif _OS == "Darwin":
