...
"""PyInstaller spec for Atlas — Windows onedir desktop build."""
            ...
            StringFileInfo(
                [
                    StringTable(
                        "040904B0",
                        [
                            StringStruct("CompanyName", "Atlas"),
                            StringStruct("FileDescription", "Atlas AI Assistant"),
                            StringStruct("FileVersion", "1.0.0"),
                            StringStruct("InternalName", "Atlas"),
                            StringStruct("OriginalFilename", "Atlas.exe"),
                            StringStruct("ProductName", "Atlas"),
